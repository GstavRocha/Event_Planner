                ...
                {evento.map(evento => (
                    <li key={evento.idEvento} className="bg-white shadow-2xl shadow-gray-800 rounded-xl p-4 mb-8">
                        ...
                        <div className="flex justify-end">
                            <button className="bg-pine-green hover:bg-oxford-blue text-white font-bold py-2 px-4 rounded mt-2 " onClick={() => reservarEvento(evento.idEvento)}>Ver descrição</button>
                        </div>
                        <div className="flex justify-end">
