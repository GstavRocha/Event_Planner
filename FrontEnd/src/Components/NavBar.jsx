...
function NavBar() {
  ...
  return (
    <nav class="bg-oxford-blue py-3 px-24 fixed w-full top-0 left-0">
    ...
    <nav className="bg-gray-800 py-3 px-24 fixed w-full top-0 left-0">
      <div className="container mx-auto flex justify-between items-center ">
        ...
        <ul class="flex space-x-6">
          <li class="nav-buttom">
            <button class="absolute inset-y-4 right-4 px-4 py-1 bg-roxo  hover:bg-oxford-blue text-white rounded-md">Login</button>
          <input className="bg-gray-700 text-white py-1 px-3 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Buscar evento..." />
